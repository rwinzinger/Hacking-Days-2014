...
- (void)application:(UIApplication *)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)devToken {
    ...
    NSString *appName = @"com.senacor.Tessel2Go"; // [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleDisplayName"];
...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo {
    ...
    alertView = [[UIAlertView alloc] initWithTitle:@"Bier ist alle!" message:@"Wie viele Dosen bringst Du mit?" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Ok", nil] ;
    alertView.tag = 2;
